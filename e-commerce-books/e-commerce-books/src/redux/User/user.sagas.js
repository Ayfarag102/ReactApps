...
export function* signUpUser({
  ...
  try {
    ...
    // yield call(handleUserProfile, { userAuth: user, data: { displayName } });
  } catch (err) {
    // console.log(err);
  }
}
...
export function* onResetPasswordStart() {
  yield takeLatest(userTypes.RESET_PASSWORD_START, resetUserPassword);
}
